...
public class RSAUtils {
    ...
    public static String encrypt(String plainText, String publicKeyStr) throws Exception {
        ...
        while (inputLen - offSet > 0) {
            ...
            System.out.println("inputLen - offSet:"+(inputLen - offSet));
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str = "安能摧眉折腰事权贵，使我不得开心颜。。1\n"
                + "安能摧眉折腰事权贵，使我不得开心颜。。2\n"
                + "安能摧眉折腰事权贵，使我不得开心颜。。3\n"
                + "安能摧眉折腰事权贵，使我不得开心颜。。4\n"
                + "安能摧眉折腰事权贵，使我不得开心颜。。5\n"
        ...
        // 公钥加密，私钥解密  乙方传输data
        System.out.println("甲方公钥加密，甲方私钥解密  乙方向甲方传输data----------保证内容不被修改---------");
        String encodedData = encrypt(str,publicKey);  //传入明文和公钥加密,得到密文
        System.out.println(" 乙方发送密文：\r\n" + encodedData);
        String decodedData = decrypt(encodedData,privateKey); //传入密文和私钥,得到明文
        System.out.println("甲方解密后文字: \r\n" + decodedData);


        System.out.println("乙方私钥加密，乙方公钥解密  乙方向甲方传输sign-----------确认发送方--------");
        Map<String, String> keyMap1 = createKeys();
        String publicKey1 = keyMap1.get("publicKey");
        String privateKey1 = keyMap1.get("privateKey");
        System.out.println("乙方公钥: \n\r" + publicKey1);
        System.out.println("乙方私钥： \n\r" + privateKey1);

        String encodedSign = signByPrivateKey(encodedData, privateKey1);
        System.out.println("乙方签名：\r\n" + encodedSign);
        //传入签名内容和公钥,得到明文
        boolean decodedSign = verifySignByPublicKey(encodedData, encodedSign,publicKey1);
        System.out.println("甲方验签: \r\n" + decodedSign);
    }
