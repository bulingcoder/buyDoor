...
@Slf4j
public class RSAUtilsCSDN {
    //https://blog.csdn.net/chen15369337607/article/details/121144348
    ...
    public static final String SIGNATURE_ALGORITHM = "MD5withRSA";
        ...
        public static void main(String[] args) {
            ...
            // 签名
            String signString = signByPrivateKey(signContent, base64PrivateKeyStr);
            ...
            boolean verifySignResult = verifySignByPublicKey(signContent ,signString, base64PublicKeyStr);
